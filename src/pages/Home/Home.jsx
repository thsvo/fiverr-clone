    ...
    <div className='home'>
      ...
      <div className="features">
        <div className="container">
          ...
          <div className="item">
            <video poster='./media/home2.jpg' src="./media/videos.mp4" controls></video>
          </div>
        </div>
      </div>

      {/*  DISCOVERED Business Component */}
      <div className="features dark">
        <div className="container">
          <div className="item">
            <h2>DISCOVERED business</h2>
            ...
            <button>Explore DISCOVERED Business</button>
          </div>
          <div className="item">
